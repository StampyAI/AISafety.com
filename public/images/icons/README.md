...
- Design on top of `grid-template-{small,default,large}.svg` (base shapes + the
  two 45° diagonals + an inner circle).

### Base shapes (outer dimensions)

Start from the base shape matching the object's natural silhouette, then adjust.

| Shape                             | small (12) | default (16) | large (24) |
| --------------------------------- | ---------- | ------------ | ---------- |
| Circle (main)                     | 10         | 13           | 20         |
| Inner circle                      | 4          | 6            | 8          |
| Vertical / high rectangle (w×h)   | 8×10       | 10×14        | 16×20      |
| Horizontal / long rectangle (w×h) | 10×8       | 14×10        | 20×16      |
| Square                            | 9          | 12           | 18         |

Small is exactly half of large; default sits between.
