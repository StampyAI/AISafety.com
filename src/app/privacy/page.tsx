      ...
      <div className="flex justify-center">
        <div className="width-9-col-narrow">
          ...
          <div className="width-7-col-narrow">
            ...
            <p className="color-teal-300 padding-bottom-40px">
              This site doesn&apos;t set cookies for visitors. The only cookie
              we use anywhere is the one our own team gets when signing in to
              the site&apos;s admin area. The site does keep two small things in
              your browser&apos;s own storage: your chatbot conversation, so it
            ...
            <p className="color-teal-300 padding-bottom-24px">
              ...
              links, and when the chatbot gets opened; it stores a random ID in
              your browser&apos;s local storage so we can count unique visitors,
              but that ID is not tied to your name, email, or IP address, and it
              never follows you to other sites.
            </p>
            <p className="color-teal-300 padding-bottom-24px">
            ...
            <p className="color-teal-300 padding-bottom-40px">
              ...
              AISafety.com team and trusted partners, and we use Claude to
              summarize the common topics people ask about. You&apos;ll see a
              notice about this in the chat window before you type anything.
              Please don&apos;t share sensitive personal information in the
              chat, and if you&apos;d like a conversation deleted, contact us
            ...
            <p className="color-teal-300 padding-bottom-40px">
              You can ask us what data we hold about you, or ask us to correct
              or delete it, by{' '}
              <a
                href="https://airtable.com/appF8XfZUGXtfi40E/pagUmmzVb8OnVvTZS/form"
                target="_blank"
