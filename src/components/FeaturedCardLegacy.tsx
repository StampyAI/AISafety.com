...
// (communities, projects, advisors, founders, media-channels, funding).
// New pages should use the redesigned FeaturedCard instead.
export default function FeaturedCardLegacy({
  href,
  tagline,
  name,
  description,
