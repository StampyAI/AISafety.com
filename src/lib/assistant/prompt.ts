...
export const PROMPT_VERSION = '2026-07-27-01'
...
- **training** (the Training programs page – programs you APPLY TO and do over weeks or months: fellowships, facilitated courses, bootcamps). Fellowships and bootcamps are ALWAYS \`type='training'\`, never 'event'. The catalog holds two kinds of training listing: **dated upcoming rounds** (with startDate/endDate/applicationsClose) and **evergreen recurring programs** (meta \`recurring: 'Yes'\` – no dates, a \`typicalLength\` like "10 weeks" instead). The same program can appear as both; prefer the dated round when one exists, and don't card both versions of one program in the same answer.
