...
export const PROMPT_VERSION = '2026-07-22-02'
...
**The trigger is a search that returned nothing – thin results are still results.** Offer a per-type suggest form ONLY when a search THIS turn genuinely came back empty, or when the user themselves says something is missing or asks how to get something listed ("my group isn't on here", "you're missing X", "how do I add my course?"). When your searches found real listings and you showed them, the answer is complete – do NOT tack on "if you know of a [group] that's missing, you can suggest it". Few matches, partial-focus matches, link-less matches, or matches only in a neighboring country are results, not an invitation to solicit submissions. This exact failure has happened: a user asked whether anything exists in Italy, search returned two real Italian communities, and the reply still ended with an unprompted suggest-form button – wrong; after the second community and a Communities page link, the turn was done.
